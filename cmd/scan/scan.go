...
import (
	...
	"github.com/whitesource/spring4shell-detect/cmd/clioptions"
	"github.com/whitesource/spring4shell-detect/cmd/clioptions/settings"
	cmdutil "github.com/whitesource/spring4shell-detect/cmd/util"
	"github.com/whitesource/spring4shell-detect/operations"
	"github.com/whitesource/spring4shell-detect/records"
	"github.com/whitesource/spring4shell-detect/screening"
	"github.com/whitesource/spring4shell-detect/supplements"
...
func NewCmdScan(logger logr.Logger, streams clioptions.IOStreams) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "scan",
		Short: "Discover projects that contain the spring4shell exploit",
...
©WhiteSource
`,
			utils.MakeOrangeText(fmt.Sprintf("spring4shell %s", strings.Join(cves, "/"))),
			o.generateRemediationSteps(enhancedResults),
			utils.MakeBlueText("https://www.whitesourcesoftware.com/resources/blog/spring4shell-vulnerability/"))
	} else {
